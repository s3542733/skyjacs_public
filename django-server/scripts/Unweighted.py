...
pkSpec = json.load(urllib.request.urlopen("http://127.0.0.1:8000/listings/16/"))
...
for dbSpec in dbSpecs:
	if dbSpec['uid'] != pkSpec['uid'] and dbSpec['user'] != pkSpec['user'] \
	and dbSpec['listing_type'] != pkSpec['listing_type']:
